...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trip.trip_start_date'
        db.add_column('traveler_trip', 'trip_start_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 11, 27)), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Trip.trip_start_date'
        db.delete_column('traveler_trip', 'trip_start_date')
    ...
    models = {
        ...
        'traveler.trip': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'trip_end_data': ('django.db.models.fields.DateField', [], {}),
