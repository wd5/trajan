...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trip.date_created'
        db.add_column('traveler_trip', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.date(2011, 11, 25), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Trip.date_created'
        db.delete_column('traveler_trip', 'date_created')
