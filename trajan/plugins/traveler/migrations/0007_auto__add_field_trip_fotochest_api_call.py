...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Trip.fotochest_api_call'
        db.add_column('traveler_trip', 'fotochest_api_call', self.gf('django.db.models.fields.CharField')(default='', max_length=350, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Trip.fotochest_api_call'
        db.delete_column('traveler_trip', 'fotochest_api_call')
